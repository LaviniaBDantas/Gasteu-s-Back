...
public record DadosDetalhamentoFuncionario(Long nroCarteira, String nome, String telefone, String funcao, LocalDate dataContratacao, Double salario, byte[] documento ) {
